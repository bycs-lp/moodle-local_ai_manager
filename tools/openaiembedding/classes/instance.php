...
/**
 * Instance class for the connector instance of aitool_openaiembedding.
 *
...
class instance extends base_instance {
    ...
    protected function extend_form_definition(\MoodleQuickForm $mform): void {
        ...
        $endpointdescription = get_string('endpointhint', 'aitool_openaiembedding')
            . '<br>' . get_string('endpointdefault', 'local_ai_manager', connector::DEFAULT_OPENAI_EMBEDDINGS_ENDPOINT);
        ...
        $endpointdescriptionazure = $mform->createElement(
            ...
            '',
            get_string('endpointhint_azure', 'aitool_openaiembedding')
            . '<br>' . get_string(
                'endpointexample',
                'local_ai_manager',
                'https://$RESOURCE.openai.azure.com/openai/deployments/'
                . '$DEPLOYMENT_ID/embeddings?api-version=$API_VERSION'
            )
        );
