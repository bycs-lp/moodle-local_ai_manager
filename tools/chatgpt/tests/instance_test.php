...
/**
 * Tests for the aitool_chatgpt instance.
 *
 * @package    aitool_chatgpt
 * @copyright  2026 ISB Bayern
 * @author     Thomas Schönlein
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers \aitool_chatgpt\instance
 */
final class instance_test extends \advanced_testcase {
    public function test_get_extended_formdata_maps_azure_model_to_selectable_model(): void {
        $instance = $this->getMockBuilder(instance::class)
            ...
            ->onlyMethods(['get_customfield1', 'get_customfield2', 'azure_enabled'])
            ->getMock();
        $instance->method('get_customfield1')->willReturn('0.5');
        ...
        $this->assertNotSame(aitool_option_azure::get_azure_model_name('chatgpt'), $data->model);
    }
}
