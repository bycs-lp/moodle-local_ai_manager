...
$string['allowindexing'] = 'Allow this resource to be indexed for RAG';
...
$string['formvalidation_editinstance_endpointnossl'] = 'For security and data privacy reasons only HTTPS endpoints are allowed, or http://localhost';
...
$string['ragindexing'] = 'Retrieval Augmented Generation Indexing';
