...
$string['endpointhint_gemini_googleai'] = 'Leave empty to use the auto-generated Google AI endpoint based on the model selected below. Fill in only to use a proxy or custom endpoint.';
$string['endpointhint_gemini_vertexai'] = 'Leave empty to use the auto-generated Vertex AI endpoint based on the service account and model configured below. Fill in only to use a custom endpoint.';
$string['endpointhint_google_fixed'] = 'Leave empty to use the default Google Text-to-Speech endpoint. Fill in only to use a proxy or custom endpoint.';
$string['endpointhint_openai'] = 'Leave empty to use the default OpenAI endpoint. Fill in only to use a proxy or alternative API endpoint.';
