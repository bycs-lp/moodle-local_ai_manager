...
$string['endpointdefault'] = 'Default: {$a}';
$string['endpointexample'] = 'Example: {$a}';
$string['endpointhint_gemini_googleai'] = 'Leave empty to use the auto-generated Google AI endpoint based on the model selected below. Only fill in to use a proxy or custom endpoint.';
$string['endpointhint_gemini_vertexai'] = 'Leave empty to use the auto-generated Vertex AI endpoint based on the service account and model configured below. Only fill in to use a custom endpoint.';
$string['endpointhint_google_fixed'] = 'Leave empty to use the default Google Text-to-Speech endpoint. Only fill in to use a proxy or custom endpoint.';
$string['endpointhint_openai'] = 'Leave empty to use the default OpenAI endpoint. Only fill in to use a proxy or alternative API endpoint.';
$string['endpointhint_openai_azure'] = 'Enter the full endpoint URL from your Azure OpenAI resource, including deployment name and API version.';
