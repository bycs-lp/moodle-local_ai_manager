...
$string['apikey_help'] = 'The secret API key used to authenticate requests to the external AI service. You can obtain this key from your AI service provider\'s dashboard. Keep this key confidential and do not share it.';
...
$string['endpoint_help'] = 'The URL of the API endpoint that requests will be sent to. Must be a valid HTTPS URL provided by your AI service. Some connectors set this automatically based on other configuration options.';
...
$string['infolink_help'] = 'An optional URL pointing to further information about this AI tool, such as a data privacy notice or terms of use page. This link will be shown to users in the AI tools overview.';
...
$string['instancename_help'] = 'A descriptive name for this AI tool configuration. This name is only used for internal identification in the administration interface and is not shown to end users.';
...
$string['model'] = 'Model';
$string['model_help'] = 'The AI model to be used for processing requests. Different models may vary in capabilities, speed, cost and quality. Choose the model that best suits your needs.';
...
$string['serviceaccountjson_help'] = 'Paste the complete contents of the JSON key file that was downloaded when you created the service account in the Google Cloud Console. This file contains the credentials needed to authenticate with Google\'s Vertex AI services.';
$string['small'] = 'small';
...
$string['temperature_defaultsetting_help'] = 'The temperature controls the randomness of the AI\'s responses. A lower value produces more focused and deterministic output, while a higher value generates more creative but less predictable results. The range is from 0 to 1.';
...
$string['use_openai_by_azure_apiversion_help'] = 'The API version to use for requests to the Azure OpenAI service, for example "2024-02-01". Check the Azure documentation for currently supported API versions.';
$string['use_openai_by_azure_deploymentid'] = 'Deployment ID of the Azure resource';
$string['use_openai_by_azure_deploymentid_help'] = 'The deployment ID you configured when deploying the model in your Azure OpenAI resource. You can find this in the Azure Portal under your resource\'s "Model deployments" section.';
$string['use_openai_by_azure_heading'] = 'Use OpenAI via Azure';
$string['use_openai_by_azure_heading_help'] = 'Enable this option if your OpenAI access is provided through Microsoft Azure instead of directly through OpenAI. When enabled, additional Azure-specific fields will appear.';
$string['use_openai_by_azure_name'] = 'Name of the Azure resource';
$string['use_openai_by_azure_name_help'] = 'The name of your Azure OpenAI resource as it appears in the Azure Portal. This is part of the endpoint URL that will be generated automatically.';
