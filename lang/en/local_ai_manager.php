...
$string['addvecstore'] = 'Add vector database';
...
$string['allowinsecurevecstore'] = 'Allow insecure (http) vector database endpoints';
$string['allowinsecurevecstoredesc'] = 'For development only. If enabled, vector database connections may use plain http:// endpoints instead of https://. Leave disabled in production.';
...
$string['collection'] = 'Collection / index name';
$string['collection_help'] = 'The name of the collection (Qdrant) or table (pgvector) where the embedding vectors are stored. If it does not exist yet, it is created automatically the first time vectors are added.';
...
$string['configurevecstore'] = 'Configure vector database';
...
$string['currentlyusedvecstores'] = 'Currently configured vector databases';
...
$string['deprecated_model'] = 'This model is deprecated and cannot be selected for new instances';
$string['deprecated_model_warning'] = 'The currently selected model is deprecated. It may stop working at any time. Please switch to a supported model.';
$string['dimensions'] = 'Vector dimensions';
$string['dimensions_help'] = 'The number of dimensions of your embedding vectors. This must match the output size of your embedding model exactly, for example 1536 for OpenAI text-embedding-3-small or 768 for many sentence-transformer models.';
$string['distance_cosine'] = 'Cosine';
$string['distance_dot'] = 'Dot product';
$string['distance_euclidean'] = 'Euclidean';
$string['distancemetric'] = 'Distance metric';
$string['distancemetric_help'] = 'How similarity between vectors is measured during a search. Cosine is the most common default; only choose Dot product or Euclidean if your embedding model documentation recommends it.';
...
$string['exception_novalidvecstore'] = 'No valid vector database backend specified';
...
$string['formvalidation_vecstore_dimensions'] = 'Please enter a positive number of dimensions';
...
$string['model_embedding'] = 'Embedding model';
$string['model_embedding_help'] = 'If enabled, this model is treated as an embedding model. Embedding models are only available and selectable for the embedding purpose and are never offered for any text based purpose.';
...
$string['model_nomodels'] = 'No models have been defined yet.';
...
$string['novecstorebackends'] = 'No vector database backends are enabled. Ask your site administrator to enable one.';
$string['novecstores'] = 'No vector databases have been configured yet.';
$string['per'] = 'per';
...
$string['setasprimary'] = 'Set as primary';
$string['small'] = 'small';
...
$string['vecstore'] = 'Vector database backend';
$string['vecstoreconnectionfailed'] = 'Could not connect to vector database "{$a}". Check the endpoint and credentials.';
$string['vecstoreconnectionok'] = 'Successfully connected to vector database "{$a}".';
$string['vecstoredeleteconfirm'] = 'Are you sure that you want to delete this vector database?';
$string['vecstoredeleted'] = 'Vector database deleted';
$string['vecstoreendpointdesc'] = 'The base URL of your vector database server, including the port (for example https://your-qdrant-host:6333).';
$string['vecstoreintro'] = 'Connect a vector database to store and search embeddings for retrieval-augmented generation (RAG).';
$string['vecstoreprimary'] = 'Primary';
$string['vecstoreprimaryset'] = 'Set "{$a}" as the primary vector database';
$string['vecstoresaved'] = 'Vector database configuration saved';
