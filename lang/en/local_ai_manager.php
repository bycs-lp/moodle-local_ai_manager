...
$string['check_usercolumns_invalid_details'] = 'Some users have invalid entries in the selected tenant column. The corresponding tenants will not be reachable. Ensure their validity or select a different userfield as the tenant column. Identifiers may only contain alphanumeric letters, hyphens, underscores or blank spaces. For the list of invalid tenants, see below.';
$string['check_usercolumns_invalid_summary'] = 'At last check, some identifiers in the user column were invalid.';
...
$string['environmentcheck_tenants_invalid'] = 'Some currently used tenant identifiers are invalid. Before upgrading, ensure their validity or select a different userfield as the tenant identifier. Identifiers may only contain alphanumeric letters, hyphens, underscores or blank spaces. ';
$string['environmentcheck_tenants_valid'] = 'All currently used tenant identifiers are valid.';
$string['environmentcheck_tenants_invalid'] = 'Some tenant identifiers are invalid. Before upgrading, ensure their validity or select a different userfield as the tenant identifier. Identifiers may only contain alphanumeric letters, hyphens, underscores or blank spaces. ';
$string['environmentcheck_tenants_valid'] = 'All current tenant identifiers are valid.';
