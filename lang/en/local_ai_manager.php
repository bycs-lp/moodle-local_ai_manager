...
$string['custommodelname'] = 'Custom model name';
$string['custommodelname_help'] = 'Enter the exact name of the model as expected by the AI service (for example "gpt-4.1-mini"). This is only used if you have selected "Custom model" in the model selection above. Make sure the model is supported by the configured endpoint.';
...
$string['formvalidation_editinstance_custommodelempty'] = 'Please specify the name of the custom model';
